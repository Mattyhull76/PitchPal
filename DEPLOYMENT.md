...
3. **Environment Variables for Vercel**
   ```
   NEXT_PUBLIC_FIREBASE_API_KEY=AIzaSyD8mVu7JFijt150fD6SGuWimcMqPCXcBbo
   ...
   NEXT_PUBLIC_FIREBASE_APP_ID=1:269472958398:web:cb1624587db5fbd4261bef
   GOOGLE_AI_API_KEY=AIzaSyDauZ07TmVUCygacTWfmCNEyJ711Ihvg78
